  ...
  return (
    <div className="home-page">
        <div className="div">
            ...
            <div className="text-wrapper-8"><a className='link' href='/'>About Us</a></div>
            <div className="text-wrapper-9"><a className='link' href='/'>Community</a></div>
            <div className="text-wrapper-10"><a className='link' href='/'>Education</a></div>
            <div className="text-wrapper-11"><a className='link' href='/'>Stay Connected</a></div>
            <div className="text-wrapper-12"><a className='link' href='/'>AboutUs</a></div>
            <div className="text-wrapper-13"><a className='link' href='/'>Community</a></div>
            <div className="text-wrapper-14"><a className='link' href='/'>Education</a></div>
            <div className="text-wrapper-15"><a className='link' href='/'>Stay Connected</a></div>
